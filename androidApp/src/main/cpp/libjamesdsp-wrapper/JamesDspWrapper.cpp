...
Java_paige_navic_shared_dsp_JamesDspWrapper_alloc(JNIEnv *env, jobject obj, jobject callback)
{
...
Java_paige_navic_shared_dsp_JamesDspWrapper_free(JNIEnv *env, jobject obj, jlong self)
{
    DECLARE_DSP_V
...
Java_paige_navic_shared_dsp_JamesDspWrapper_getBenchmarkSize(JNIEnv *env, jobject obj) {
    return MAX_BENCHMARK;
}

extern "C" JNIEXPORT void JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_runBenchmark(JNIEnv *env, jobject obj, jdoubleArray jc0, jdoubleArray jc1)
{
...
extern "C" JNIEXPORT void JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_loadBenchmark(JNIEnv *env, jobject obj, jdoubleArray jc0, jdoubleArray jc1)
{
...
Java_paige_navic_shared_dsp_JamesDspWrapper_setSamplingRate(JNIEnv *env,
                                                                                 jobject obj,
                                                                                 jlong self,
                                                                                 jfloat sample_rate,
...
Java_paige_navic_shared_dsp_JamesDspWrapper_isHandleValid(JNIEnv *env, jobject obj, jlong self)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_processInt16(JNIEnv *env, jobject obj, jlong self, jshortArray inputObj, jshortArray outputObj, jint offset, jint size)
{
    DECLARE_DSP_V
...
extern "C"
JNIEXPORT void JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_processInt32(JNIEnv *env, jobject obj, jlong self, jintArray inputObj, jintArray outputObj, jint offset, jint size)
{
    DECLARE_DSP_V
...
Java_paige_navic_shared_dsp_JamesDspWrapper_processInt24Packed(JNIEnv *env, jobject obj, jlong self, jbooleanArray inputObj)
{
...
Java_paige_navic_shared_dsp_JamesDspWrapper_processInt8U24(JNIEnv *env, jobject obj, jlong self, jintArray inputObj)
{
    // Return inputObj if DECLARE failed
    DECLARE_DSP(inputObj)
...
extern "C"
JNIEXPORT void JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_processFloat(JNIEnv *env, jobject obj, jlong self, jfloatArray inputObj, jfloatArray outputObj, jint offset, jint size)
{
    DECLARE_DSP_V
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setLimiter(JNIEnv *env, jobject obj, jlong self, jfloat threshold, jfloat release)
{
    DECLARE_DSP_B
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setPostGain(JNIEnv *env, jobject obj, jlong self, jfloat gain)
{
    DECLARE_DSP_B
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setMultiEqualizer(JNIEnv *env, jobject obj, jlong self,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setVdc(JNIEnv *env, jobject obj, jlong self,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setCompander(JNIEnv *env, jobject obj, jlong self,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setReverb(JNIEnv *env, jobject obj, jlong self,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setConvolver(JNIEnv *env, jobject obj, jlong self,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setGraphicEq(JNIEnv *env, jobject obj, jlong self,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setCrossfeed(JNIEnv *env, jobject obj, jlong self,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setBassBoost(JNIEnv *env, jobject obj, jlong self,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setStereoEnhancement(JNIEnv *env, jobject obj, jlong self,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setVacuumTube(JNIEnv *env, jobject obj, jlong self,
                                                                              jboolean enable, jfloat level)
{
    DECLARE_DSP_B
    if(enable)
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_setLiveprog(JNIEnv *env, jobject obj, jlong self,
...
Java_paige_navic_shared_dsp_JamesDspWrapper_enumerateEelVariables(JNIEnv *env, jobject obj, jlong self)
{
...
extern "C" JNIEXPORT jboolean JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_manipulateEelVariable(JNIEnv *env, jobject obj, jlong self,
...
extern "C" JNIEXPORT void JNICALL
Java_paige_navic_shared_dsp_JamesDspWrapper_freezeLiveprogExecution(JNIEnv *env, jobject obj, jlong self,
                                                                                        jboolean freeze)
{
    DECLARE_DSP_V
...
Java_paige_navic_shared_dsp_JamesDspWrapper_eelErrorCodeToString(JNIEnv *env,
                                                                                     jobject obj,
                                                                                     jint error_code)
{
...
{
    // Navic Phase 1: no crash-reporting SDK wired up for the native layer yet,
    // so the original RootlessJamesDSP Crashlytics::Initialize() call is dropped.
